...
function Simson() {
    ...
    const calculateSimpson = () => {
        ...
        const sum = evaluateFunc(aNum) + 4 * evaluateFunc(h) + evaluateFunc(bNum); // f(a) + 4f(mid) + f(b)
        const result = (h / 3) * sum; // Area calculation
    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center">
                <h1 className="mb-5">Single Simpson's Rule</h1>
                ...
                <div className="flex gap-6 justify-center">
                    <button className="btn btn-primary mt-5" onClick={calculateSimpson}>
                        คำนวณ
                    </button>
